...
const styles = StyleSheet.create({
  ...
  inputCard: { backgroundColor: '#fff', padding: 20, borderRadius: 12, marginBottom: 20, elevation: 2 },
  label: { color: '#666', marginBottom: 8 },
  input: { fontSize: 32, fontWeight: 'bold', color: '#4EA8DE' },
  resultsCard: { backgroundColor: '#fff', borderRadius: 12, padding: 10, elevation: 2 },
  row: { flexDirection: 'row', justifyContent: 'space-between', padding: 15, borderBottomWidth: 1, borderBottomColor: '#eee' },
